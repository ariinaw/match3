...
{   
	public class MatchManager : MonoBehaviour
	{
		...
		public int addPoint = 1; // очки
		public int pointToLevel = 12; // очки для след уровня
        ...
        {
			moneyCount.text = $"score: {money}";
			if (money >= pointToLevel)
			{
		...
		public IEnumerator CheckForMatches(bool needSwapBack = true) //ходы 
		{
